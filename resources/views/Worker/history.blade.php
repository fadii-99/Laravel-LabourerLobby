...
<body>
    ...
    <header>
        <div class="container">
            ...
            <nav>
                <ul>
                    <li><a style="text-decoration:none; color:black;" class="effect"
                            href="/profilew">{{ session('worker')['name'] }}</a></li>
                    <li><a style="text-decoration:none; color:black;" class="effect"
                            href="{{ URL::to('lobby') }}">LOBBY</a></li>
                    <li><a style="color: black; text-decoration:none;" class="effect"
                            href="{{ URL::to('complain') }}">COMPLAIN</a></li>
                </ul>
            </nav>
        </div>
    </header>
                    ...
                    <tbody style="color:black;">
                        @foreach ($HH as $el)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ URL::to('deletehistory/' . $el->id) }}"
